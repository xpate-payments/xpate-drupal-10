...
class ResultController extends ControllerBase
{
   ...
   */
  public function onFinish(Request $request): array
  {
    // Your code here.
   ...
   * @return string
   */
  public function getStatusErrorMessage(array $result): string
  {
    // Your code here.
   ...
   *   Message.
   */
  public function getSuccessMessage(Request $request): string
  {
    // Your code here.
